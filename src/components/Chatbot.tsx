...
useEffect(() => {
  ...
  switch (stage) {
    ...
    case CHAT_STAGES.CONFIRMATION:
      if (userResponse.toLowerCase().includes('ya')) {
        ...
        botReply(`Terima kasih! Pengaduan Anda telah berhasil dikirim. Nomor tiket Anda adalah: ${ticketNumber}. Tim kami akan segera menindaklanjuti.`);
  ...
  const handleSendMessage = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (inputValue.trim() && !isBotTyping && stage !== CHAT_STAGES.COMPLETED) {
      ...
      <div className="p-4 bg-gray-100 border-t">
        <form onSubmit={handleSendMessage} className="flex items-center gap-3">
          <input
            ...
            placeholder={
                isBotTyping ? "Bot sedang mengetik..." : 
            ...
            disabled={isBotTyping || stage === CHAT_STAGES.COMPLETED}
          />
          <button
            type="submit"
            ...
            disabled={isBotTyping || !inputValue.trim() || stage === CHAT_STAGES.COMPLETED}
          >
